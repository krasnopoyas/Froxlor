...
$lng['admin']['mysqlserverversion'] = 'Весия MySQL';
...
$lng['menue']['ticket']['archive'] = 'Архив тикетов';
...
$lng['ticket']['ticket_new'] = 'Открыть новый тикет';
...
$lng['ticket']['ticketcount'] = 'Тикет';
$lng['ticket']['ticket_answers'] = 'Replies';
$lng['ticket']['lastchange'] = 'Последнее действие';
$lng['ticket']['subject'] = 'Описание';
$lng['ticket']['status'] = 'Статус';
$lng['ticket']['lastreplier'] = 'Last replier';
$lng['ticket']['priority'] = 'Приоритет';
$lng['ticket']['low'] = 'Низкий';
$lng['ticket']['normal'] = 'Нормальный';
$lng['ticket']['high'] = 'Высокий';
$lng['ticket']['lastchange'] = 'Последнее изменение';
$lng['ticket']['lastchange_from'] = 'От даты (dd.mm.yyyy)';
$lng['ticket']['lastchange_to'] = 'До даты (dd.mm.yyyy)';
$lng['ticket']['category'] = 'Категория';
$lng['ticket']['no_cat'] = 'None';
$lng['ticket']['message'] = 'Сообщение';
$lng['ticket']['show'] = 'View';
$lng['ticket']['answer'] = 'Answer';
$lng['ticket']['close'] = 'Закрыть';
$lng['ticket']['reopen'] = 'Re-open';
$lng['ticket']['archive'] = 'Архив';
$lng['ticket']['ticket_delete'] = 'Удалить тикет';
$lng['ticket']['lastarchived'] = 'Recently archived tickets';
$lng['ticket']['archivedtime'] = 'Archived';
$lng['ticket']['open'] = 'Открыть';
$lng['ticket']['wait_reply'] = 'Waiting for reply';
$lng['ticket']['replied'] = 'Replied';
$lng['ticket']['closed'] = 'Зарыть';
...
$lng['admin']['tickets']['daily'] = 'Ежедненвно';
$lng['admin']['tickets']['weekly'] = 'Еженедельно';
$lng['admin']['tickets']['monthly'] = 'Ежемесячно';
$lng['admin']['tickets']['yearly'] = 'Ежегодно';
...
$lng['traffic']['mb'] = "Traffic (МБ)";
$lng['traffic']['distribution'] = '<font color="#019522">FTP</font> | <font color="#0000FF">HTTP</font> | <font color="#800000">Mail</font>';
$lng['traffic']['sumhttp'] = 'Сумарно HTTP-Traffic';
$lng['traffic']['sumftp'] = 'Сумарно FTP-Traffic';
$lng['traffic']['summail'] = 'Сумарно Mail-Traffic';
...
$lng['admin']['cron']['cronsettings'] = 'Настройки крона';
$lng['cron']['cronname'] = 'cronjob-name';
$lng['cron']['lastrun'] = 'последний запуск';
$lng['cron']['interval'] = 'интервал';
$lng['cron']['isactive'] = 'enabled';
$lng['cron']['description'] = 'description';
$lng['crondesc']['cron_unknown_desc'] = 'no description given';
$lng['admin']['cron']['add'] = 'Добавить задание в крон';
...
$lng['cronmgmt']['minutes'] = 'мимунты';
$lng['cronmgmt']['hours'] = 'часы';
$lng['cronmgmt']['days'] = 'дни';
$lng['cronmgmt']['weeks'] = 'недели';
$lng['cronmgmt']['months'] = 'месяцы';
$lng['admin']['cronjob_edit'] = 'Редактировать крон';
$lng['cronjob']['cronjobsettings'] = 'Настройик крона';
$lng['cronjob']['cronjobintervalv'] = 'Runtime interval value';
$lng['cronjob']['cronjobinterval'] = 'Runtime interval';
$lng['panel']['options'] = 'Настройки';
...
$lng['ftp']['account_edit'] = 'Редактивароть ftp аккаунт';
